...
const testimonials = [
  {
    name: 'Ramesh Yadav',
    role: 'Founder, KisanTech',
    review: 'MVPWay ne hamare agri-platform ko 4 hafte mein live kar diya. Code quality ekdum production-ready thi — koi rewrite nahi hua.',
    rating: 5,
  },
  {
    name: 'Priya Murmu',
    role: 'CEO, VanDhan',
    review: 'Being a first-generation entrepreneur from a tribal background, I needed a team that believed in my vision. MVPWay delivered beyond expectations.',
    rating: 5,
  },
  {
    name: 'Rajkumar Paswan',
    role: 'Co-Founder, SkilEdge',
    review: 'I had a limited budget and a big dream. MVPWay helped me launch a skilling platform that is now used by thousands of youth in Bihar and UP.',
    rating: 5,
  },
  {
    name: 'Sunita Kurmi',
    role: 'Founder, GrameenCart',
    review: 'Our rural e-commerce idea seemed too niche for most agencies. MVPWay understood our users, built fast, and the platform is thriving.',
    rating: 5,
  },
  {
    name: 'Dinesh Meghwal',
    role: 'Product Lead, CraftLink',
    review: 'MVPWay connected our artisan community to digital commerce in just 5 weeks. Kunal and Maneesh treated our mission with real respect.',
    rating: 5,
  },
  {
    name: 'Jyoti Hembram',
    role: 'Co-Founder, TribeHeal',
    review: 'Building a health platform for tribal communities is no small task. MVPWay got it right — culturally aware design and rock-solid backend.',
    rating: 5,
  },
]
